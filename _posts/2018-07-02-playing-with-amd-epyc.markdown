...
https://gist.github.com/tiernano/4877abe19c89f1e45e617da1b4d46447
...
In total, there was about 1500 photos exported, and the total file size was XXX Gb. First obstial was to get them uploaded to the Packet machine, which took a while (my upload speed is currently 40Mbit/s)... Once up, i downloaded a copy of dotnet core 2.0 SDK, cloned the repo with the project, built and ran... and man, its fast! Running the same code on GodBoxV2 on the bare metal (no VM this time), i got XX min of a run... 
